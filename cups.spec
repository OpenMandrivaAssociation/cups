...
# This is NOT the Fedora patch by the same name. They make wrong
# assumptions (cups devel requiring gnutls devel) while our
# variant is a far more obvious solution.
